  ...
  return (
    <Grid container justifyContent={"center"}>
      ...
      <ConquistaBox>
        ...
        <HeadingTwo>
          Completou 7 tarefas da categoria <strong>Social</strong>
        </HeadingTwo>
      </ConquistaBox>
      <ConquistaBox>
      ...
      <ConquistaBox>
        <ConquistaImg
          src={MagoDaSabedoriaHidrica}
          alt="Icone Mago da Sabedoria Hidrica "
        />
        <HeadingOne>Mago da Sabedoria Hídrica</HeadingOne>
        <HeadingTwo>
          Completou 7 tarefas da categoria <strong>Água</strong>
        </HeadingTwo>
      </ConquistaBox>
      <ConquistaBox>
        <ConquistaImg
          src={MestreEficienciaEnergetica}
          alt="Icone Mestre da Eficiencia Energetica"
        />
        <HeadingOne>Mestre da Eficiência Energética</HeadingOne>
        <HeadingTwo>
          Completou 7 tarefas da categoria <strong>Energia</strong>
        </HeadingTwo>
      </ConquistaBox>
      <ConquistaBox>
        <ConquistaImg
          src={CampeaoReciclagem}
          alt="Icone Campeao de Reciclagem"
        />
        <HeadingOne>Campeão da Reciclagem</HeadingOne>
        <HeadingTwo>
          Completou 7 tarefas da categoria <strong>Reciclagem</strong>
        </HeadingTwo>
      </ConquistaBox>
      <ConquistaBox>
      ...
      <ConquistaBox>
        <ConquistaImg
          src={EsmagadorCarbono}
          alt="Icone Esmagador da Pegada de Carbono.png"
        />
        <HeadingOne>Esmagador da Pegada de Carbono</HeadingOne>
        <HeadingTwo>
          Completou 7 tarefas da categoria <strong>transporte</strong>
        </HeadingTwo>
      </ConquistaBox>
    </Grid>
  );
